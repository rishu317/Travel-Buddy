...
import costaRicaData from "../Data/costaRicaData";
...
const CostaRicaDest = () => {
  ...
  const filteredDestinations = costaRicaData.filter((dest) =>
    ...
    <div className="p-6">
      ...
      <section className="text-center mb-8">
        <h1 className="text-4xl font-bold text-blue-700 w-auto">
          Explore Costa Rica's Destinations
        </h1>
