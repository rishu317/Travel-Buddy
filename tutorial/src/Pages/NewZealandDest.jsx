...
import newZealandData from "../Data/newZealandData";
import Contries from "../components/DestinationsForContries";

const NewZealandDest = () => {
  const [searchTerm, setSearchTerm] = useState("");

  const filteredDestinations = newZealandData.filter((dest) =>
    ...
    <div className="p-6">
      ...
      <section className="text-center mb-8">
        <h1 className="text-4xl font-bold text-blue-700 w-auto">
          Explore New Zealand's Destinations
        </h1>
      ...
      <section>
        {filteredDestinations.length > 0 ? (
          ...
          <p className="text-center text-gray-500 mt-8">No destinations found.</p>
        )}
      </section>
    </div>
  );
